...
class ConfigTablePKR
{
	...
	public function delete($deinst_org_select)
	{
    	...
    	$result_sum  = ($result_data ? $gL10n->get('PKR_DEINST_DATA_DELETE_SUCCESS') : $gL10n->get('PKR_DEINST_DATA_DELETE_ERROR') );
		$result_sum .= ($result_db ? $gL10n->get('PKR_DEINST_TABLE_DELETE_SUCCESS') : $gL10n->get('PKR_DEINST_TABLE_DELETE_ERROR') );
    	$result_sum .= ($result_data ? $gL10n->get('PKR_DEINST_ENDMESSAGE') : '' );
